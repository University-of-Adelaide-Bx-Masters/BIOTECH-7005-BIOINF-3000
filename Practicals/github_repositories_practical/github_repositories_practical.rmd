...
If the repo is public (and you didn't have to enter it when you pulled) you will have to enter your github username and password now. The password is the access token (not GitHub password)
...
There's a [GitHub repository Practical project](https://github.com/davmlaw/2023_practical_github_repositories) which is a simulation of an open source project with bugs.
...
Raise an issue in the [GitHub repository Practical project](https://github.com/davmlaw/2023_practical_github_repositories) for the high severity bug (XXXXXXX)
