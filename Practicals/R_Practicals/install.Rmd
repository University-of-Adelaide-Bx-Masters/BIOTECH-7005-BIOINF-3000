...
1. **The [R Software](https://cran.r-project.org/bin/macosx/) itself.**
    + The latest release is 4.1.0, however any version >4.0 will be suitable. 
...
1. **The [R Software](https://cran.r-project.org/bin/windows/base/) itself.** The latest release is 4.1.0, however any version >3.6 will be suitable
2. The IDE [R Studio](https://www.rstudio.com/products/rstudio/download/#download) which is the software we use to interact with R
...
```
wget https://download1.rstudio.org/desktop/bionic/amd64/rstudio-2022.07.0-548-amd64.deb
sudo gdebi -n rstudio-2022.07.0-548-amd64.deb
