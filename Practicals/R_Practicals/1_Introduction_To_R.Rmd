...
author: "Steven Delean (material from Bioinformatics Hub, University of Adelaide)"
date: "27 July 2021"
output: 
  html_document: 
    fig_caption: yes
...
Click this and you should see the following text (or similar depending on your version):
...
**Please ensure you spell this correctly, including the underscore and capitalised first letter. It is important when using scripting languages to never use spaces in the names of files or folders, so please get into the practice of following this rule from now on!**
