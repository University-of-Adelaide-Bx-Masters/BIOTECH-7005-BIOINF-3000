...
This will mention having a "detached head" - HEAD keeps track of the current point in a repository. Usually, it is attached to a branch (eg main), while moving through history, it's "detached"
...
There are 2 common conventions on how to stucture branches in a repo:
