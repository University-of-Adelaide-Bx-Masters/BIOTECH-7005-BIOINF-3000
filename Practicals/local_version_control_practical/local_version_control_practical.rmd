...
This should show you that you have 1 untracked file called 'README.md'. Run:
...
```
git tag cyan_monkey <hash from git log>  # need to change to your hash
```
...
https://github.com/SACGF/cdot/compare/v0.2.7...v0.2.8
