...
::: {.fragment}
- We use Negative Binomial distributions to model counts

$$
X \sim \text{NB}\left(\frac{\mu}{\sigma^2}, \frac{\mu^2}{\sigma^2 - \mu}\right), \text{where }E[X] = \mu \text{; Var}[X] = \sigma^2
$$
:::
::: {.fragment}
...
::: {.fragment}
- Same model for transcripts, but dividing counts by uncertainty estimate
